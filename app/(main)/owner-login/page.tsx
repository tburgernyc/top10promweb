...
export const metadata: Metadata = {
  title: 'Owner Login | Top 10 Prom',
  description: 'Store owner and admin sign-in portal for Top 10 Prom boutique management.',
}
...
export default function OwnerLoginPage() {
  return (
    <div className="relative min-h-dvh flex items-center justify-center px-4 py-12 overflow-hidden">
      ...
      {/* Darker overlay for owner portal */}
      ...
      <div className="relative z-10 w-full">
        <div className="text-center mb-8">
          ...
          <p className="text-platinum/50 text-xs tracking-widest uppercase mt-1">Owner Portal</p>
        </div>
