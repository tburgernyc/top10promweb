  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col items-center gap-6 pointer-events-auto">
        ...
        >
          <EventPill label="Prom" onClick={() => enter('prom')} tabIndex={2} shouldReduce={!!shouldReduce} />
          <EventPill label="Wedding" onClick={() => enter('wedding')} tabIndex={3} shouldReduce={!!shouldReduce} />
        </motion.div>
